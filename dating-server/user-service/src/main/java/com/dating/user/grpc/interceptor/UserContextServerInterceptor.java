package com.dating.user.grpc.interceptor;
...
// 全局 ServerInterceptor:把 metadata 写进 gRPC Context + MDC。
// MDC 在 interceptCall 内 set,在返回的 ListenerWrapper.onComplete/onCancel 里 clear,
...
public class UserContextServerInterceptor implements ServerInterceptor {
    ...
    // 包装 Listener,RPC handler 在异步线程上回调时由各回调方法重新设置/清理 MDC。
